...
public class DirectionFinder {
    ...
    private String createUrl() throws UnsupportedEncodingException {
        Log.d("urlOrigin::",origin.latitude+" "+origin.longitude);
        Log.d("urlDestination::",destination.latitude+" "+destination.longitude );
      ...
      //  Log.d("urlDestination::", String.valueOf(DIRECTION_URL_API + urlDestination));
        String locationURL = DIRECTION_URL_API + "origin=" + urlOrigin + "&destination=" + urlDestination + "&key=" + GOOGLE_API_KEY;
    ...
    private void parseJSon(String data) throws JSONException {
        ...
        for (int i = 0; i < jsonRoutes.length(); i++) {
            ...
            Log.d("INSIDE for loop::::::::", "enteringds");
            ...
            route.points = decodePolyLine(overview_polylineJson.getString("points"));
            Log.d("ADDING ROUTES:::::::", "enteringds");
            routes.add(route);
            // }
